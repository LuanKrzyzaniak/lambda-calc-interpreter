...
happyExpList = Happy_Data_Array.listArray (0,96) ([41408,2120,8,0,0,0,15,0,0,0,0,10352,530,0,49216,18593,14344,2324,1,0,3840,64,480,2,8192,0,64,61440,2,41408,2120,5176,265,8839,57377,9296,4,0,0,0,1536,0,224,0,0,0,49408,0,0,20704,1060,35356,132,60,2,0,0,48,0,1544,0,0,0,0,2560,7168,33930,0,3088,10352,530,0,0,0,0,0,0,0,0
	])

{-# NOINLINE happyExpListPerState #-}
happyExpListPerState st =
    token_strs_expected
  where token_strs = ["error","%dummy","%start_parser","Exp","Ty","ListElements","num","true","false","'+'","'*'","\"&&\"","\"||\"","'('","')'","\"\\\\\"","':'","'.'","\"->\"","'['","']'","','","if","then","else","Num","Bool","var","%eof"]
        bit_start = st * 29
        bit_end = (st + 1) * 29
...
action_12 (22) = happyShift action_27
...
action_40 (19) = happyShift action_37
